...
class HoverPyPoseMPC(Hover):
    """
    Hover 태스크를 PyPose 기반 differentiable MPC(iLQR)로 제어하는 변형.
    ...
    def _init_controller(self):
        ...
        if bool(self.cfg.task.get("mpc_debug_print_B", False)):
            ...
            print("[HoverPyPoseMPC] thrust_axis:", thrust_axis)
            print("[HoverPyPoseMPC] B source:", B_src)
            print("[HoverPyPoseMPC] B (6 x n):\n", B)
