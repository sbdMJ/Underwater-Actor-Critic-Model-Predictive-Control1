"""
Isaac Sim 없이 PyPose differentiable MPC gradient를 확인하는 간단한 데모.

실행:
  python scripts/demo_pypose_mpc_grad.py
"""
...
def main():
    ...
    uav_params = {
        ...
        "thruster_allocation": torch.eye(6, nu).numpy(),  # tau = u_force (toy)
        "volume": 0.012,
        "coBM": 0.02,
        "rho": 997.0,
        "g": 9.81,
